...
public class Jhipster1StappsApp {

    private static final Logger log = LoggerFactory.getLogger(Jhipster1StappsApp.class);

    private final Environment env;

    public Jhipster1StappsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipster1stapps.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhipster1StappsApp.class);
